...
<head>
    ...
    <title>PT. KATOLEC INDONESIA | REGISTER</title>
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                @enderror
                                 ...
                                 <div class="form-group">
                                        <input id="nik" type="text" class="form-control form-control-user @error('nik') is-invalid @enderror" name="nik" value="{{ old('nik') }}" required autocomplete="nik" placeholder="NIK ( Nomor Induk Karyawan)" autofocus>
                                ...
                                @enderror
                                 ...
                                 <div class="form-group">
                                        <input id="section" type="text" class="form-control form-control-user @error('section') is-invalid @enderror" name="section" value="{{ old('section') }}" required autocomplete="section" placeholder="Seksi" autofocus>
                                ...
                                @enderror
                                 ...
                                 <div class="form-group">
                                        <input id="no_hp" type="text" class="form-control form-control-user @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ old('no_hp') }}" required autocomplete="no_hp" placeholder="Nomor Handphone" autofocus>
